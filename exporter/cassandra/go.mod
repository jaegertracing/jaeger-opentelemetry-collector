module github.com/jaegertracing/jaeger-opentelemetry-collector/exporter/cassandra

go 1.18

replace github.com/jaegertracing/jaeger-opentelemetry-collector => ../..

require (
	github.com/jaegertracing/jaeger v1.37.0
	github.com/jaegertracing/jaeger-opentelemetry-collector v0.0.0-00010101000000-000000000000
